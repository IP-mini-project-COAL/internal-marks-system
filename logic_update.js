...
let r_flag = a[0];
            ...
            el("i_submit").addEventListener('click',function(){
                                                                ...
                                                                if(success_result==0){
                                                                    ...
                                                                    $.ajax({
                                                                        ...
                                                                        success:function(marks){
                                                                            ...
                                                                            el("ia1").value = marks["ia1"];
                                                                            el("ia2").value = marks["ia2"];
                                                                            el("q1").value = marks["q1"];
                                                                            el("q2").value = marks["q2"];
                                                                            el("q3").value = marks["q3"];
                                                                            el("q4").value = marks["q4"];
                                                                            el("a1").value = marks["a1"];
                                                                            el("a2").value = marks["a2"];
                                                                            el("a3").value = marks["a3"];
                                                                            el("a4").value = marks["a4"];
                                                                            el("e1").value = marks["e1"];
                                                                            el("e2").value = marks["e2"];
                                                                            el("e3").value = marks["e3"];
                                                                            el("e4").value = marks["e4"];
                                                                            el("e5").value = marks["e5"];
                                                                            el("e6").value = marks["e6"];
                                                                            el("e7").value = marks["e7"];
                                                                            el("e8").value = marks["e8"];
                                                                            el("e9").value = marks["e9"];
                                                                            el("e10").value = marks["e10"];
                                                                            el("proj").value = marks["mp"];
                                                                            el("fg").classList.add("deactivate");
                                                                            el("u_m").classList.add("activate");
                                                                            ...
                                                                            el("submit").addEventListener('click',function(){
                                                                                ...
                                                                                let name = el("sname").value,
                                                                                    ...
                                                                                    $.ajax({
                                                                                        url:"update.php",
                                                                                        method:"POST",
                                                                                        data:{"flag":up_flag,"sem":sem,"dept":dept,"ay":ay,"name":name,"rno":rno,"year":year,"sub_code":sub_code,
